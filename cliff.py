    ...
    if (algo==0):
        ...
        #         print(c.Q)
                if done:
                    ...
                    if (j>9):
                        if (j%10==0):
                            med = 1/float(20)*sum(mid)
                            mid = []
                        rew.append(r*abs(med)/abs(r))
                    else:
                        rew.append(r)
                    num2.append(num)
...
#                 
#             num = 0
#         return c.Q,row,rew,count,epsilon
#     elif(algo == 1):
#         for j in range(episode):
#             num = 0
#             row = []
...
#    
# c = cliffWalking(start,end)
# Q,row,rew,count,epsilon = rlcliffdyn(c, episode, step, alpha, gamma, epsilon, 0)
# c=cliffWalking(start,end)
# Q_q,row_q,rew_q,count_q,epsilon_q = rlcliffdyn(c, episode, step, alpha, gamma, epsilon, 1)
# plt.subplot(211)
